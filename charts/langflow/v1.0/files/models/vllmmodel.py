...
class VLLMModelComponent(LCModelComponent):
    display_name = "vLLM"
    description = "Generate text using e-INFRA CZ vLLMs."
    icon = "OpenAI"
    name = "vLLM"
    ...
    async def update_build_config(self, build_config: dict, field_value: Any, field_name: str | None = None):
        if field_name == "model_name":
            ...
            if base_url_load_from_db:
                ...
                base_url_value = "https://vllm.ai.e-infra.cz/v1"
    ...
    inputs = [
        *LCModelComponent._base_inputs,
        ...
        StrInput(
            ...
            advanced=False,
            info="Endpoint of the vLLM API. Defaults to 'https://vllm.ai.e-infra.cz/v1' if not specified.",
            value="https://vllm.ai.e-infra.cz/v1",
        ),
        SecretStrInput(
            name="api_key",
            display_name="vLLM API Key",
            info="The vLLM API Key to use for vLLM instance.",
            advanced=True,
            value="EMPTY",
        ),
        FloatInput(
    ...
    def build_model(self) -> LanguageModel:  # type: ignore[type-var]
        ...
        base_url = self.base_url or "https://vllm.ai.e-infra.cz/v1"
        seed = self.seed
