...
class VLLMEmbeddingsComponent(LCEmbeddingsModel):
    display_name: str = "vLLM Embeddings"
    description: str = "Generate embeddings using vLLM."
    icon = "OpenAI"
    ...
    def build_embeddings(self) -> Embeddings:
        try:
            ...
            msg = "Please install langchain-nvidia-ai-endpoints to use vLLM Embeddings."
        ...
        try:
            ...
            msg = f"Could not connect to vLLM API. Error: {e}"
            raise ValueError(msg) from e
        return output
